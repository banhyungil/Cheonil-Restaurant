...
<template>
    <div>
        ...
        >
            <div v-if="variant == 'file'" class="absolute bottom-0 left-0 right-0 top-0 m-auto flex items-center justify-center text-white">
                {{ type }}
            </div>
            <div v-if="variant == 'image'" class="image-fit absolute left-0 top-0 h-full w-full">
