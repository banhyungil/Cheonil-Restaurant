...
const computedClass = computed(() => [
    ...
    breadcrumb &&
        !breadcrumb.light &&
        index > 0 &&
        "before:content-[''] before:w-[14px] before:h-[14px] before:bg-bredcrumb-chevron-dark before:bg-size-[100%] before:-ml-4.5 before:absolute before:my-auto before:inset-y-0",
    breadcrumb &&
        breadcrumb.light &&
        index > 0 &&
        "before:content-[''] before:w-[14px] before:h-[14px] before:bg-bredcrumb-chevron-light before:bg-size-[100%] before:-ml-4.5 before:absolute before:my-auto before:inset-y-0",
