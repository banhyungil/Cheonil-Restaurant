...
const modelValue = defineModel<InputHTMLAttributes['value']>({ required: false })
...
<template>
    <input :class="[computedClass, 'focus:ring-primary focus:ring-opacity-30']" :type="props.type" v-bind="_.omit(attrs, 'class')" v-model="modelValue" />
</template>
